...
// Error page props
const statusCode = String(props.error.statusCode || 500)
...
const stack = process.dev ? props.error.description || `<pre>${stacktrace}</pre>` : undefined
