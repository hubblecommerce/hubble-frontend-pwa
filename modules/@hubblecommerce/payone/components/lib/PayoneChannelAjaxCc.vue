...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            cardType: function() {
                return this.chosenPaymentMethod.payload.cardType;
            },
            cardExpireDate: function() {
                return this.chosenPaymentMethod.payload.cardExpireDate;
            },
            pseudoCardPan: function() {
                return this.chosenPaymentMethod.payload.pseudoCardPan;
            },
            reference: function() {
        ...
        methods: {
            ...
            setDynamicRequestData: function() {
                return new Promise((resolve) => {
                    ...
                    this.requestData.pseudocardpan = this.pseudoCardPan;
                    this.requestData.cardtype = this.cardType;
                    this.requestData.cardexpiredate = this.cardExpireDate;
                    resolve();
                });
            }
        }
