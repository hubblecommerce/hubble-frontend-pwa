        ...
        <form v-if="!scriptError" name="paymentform" method="post">
            <fieldset>
                ...
                <div class="cc-check-row">
                    ...
                    <span id="cardpan" class="inputIframe" /> <!-- Container for PAYONE-Script -> PAYONE will place an iFrame in here -->
                </div>
            ...
            return {
                ...
                config: {
                    fields: {
                        cardpan: {
                            selector: "cardpan",
                            style: "font-size: 14px; width: 248px; border: solid 1px #EAE9EA; height: 42px; color: #535358; font-family: 'Lato', Helvetica, Arial, sans-serif; background: #F8F8F8; padding: 10px;",
                            styleFocus: "font-size: 14px; width: 248px; border: solid 1px #535358; outline: none; height: 42px; color: #535358; font-family: 'Lato', Helvetica, Arial, sans-serif; background: #F8F8F8; padding: 10px; ",
                            type: "input"
                        },
                        cardcvc2: {
                            selector: "cardcvc2",
                        ...
                        cardexpiremonth: {
                            ...
                            style: "font-size: 14px; width: 122px; border: solid 1px #EAE9EA; height: 42px; color: #535358; font-family: 'Lato', Helvetica, Arial, sans-serif; background: #F8F8F8; padding: 10px;",
                            styleFocus: "font-size: 14px; width: 122px; border: solid 1px #535358; outline: none; height: 42px; color: #535358; font-family: 'Lato', Helvetica, Arial, sans-serif; background: #F8F8F8; padding: 10px; "
                        },
                        cardexpireyear: {
                        ...
                        cardtype: {
                            selector: "cardtype",
                            cardtypes: ["#", "A", "M", "V"],
                            style: "font-size: 14px; width: 248px; border: solid 1px #EAE9EA; height: 42px; color: #535358; font-family: 'Lato', Helvetica, Arial, sans-serif;",
                            styleFocus: "font-size: 14px; width: 248px; border: solid 1px #535358; outline: none; height: 42px; color: #535358; font-family: 'Lato', Helvetica, Arial, sans-serif; background: #F8F8F8; padding: 10px; "
                        }
                    },
                    defaultStyle: {
