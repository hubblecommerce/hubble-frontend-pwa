    ...
    export default {
        ...
        computed: {
            ...
            sb: function() {
                ...
                if(!_.isEmpty(this.chosenPaymentMethod.payload)) {
                    sb = this.chosenPaymentMethod.payload;
                }
        ...
        methods: {
            ...
            setDynamicRequestData: function() {
                return new Promise((resolve) => {
                    ...
                    this.requestData.onlinebanktransfertype = this.sb.onlinebanktransfertype;
                    this.requestData.iban = this.sb.iban;
                    this.requestData.bic = this.sb.bic;
                    resolve();
                });
            }
        }
