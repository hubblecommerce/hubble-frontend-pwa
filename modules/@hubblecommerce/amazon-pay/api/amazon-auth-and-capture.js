...
const response = function (req, res, next) {
    ...
    axios({
        ...
        url:
            ...
            parameters['AuthorizationAmount.Amount'] +
            '&AuthorizationAmount.CurrencyCode=' +
            parameters['AuthorizationAmount.CurrencyCode'] +
            '&AuthorizationReferenceId=' +
            parameters.AuthorizationReferenceId +
            '&CaptureNow=' +
            parameters.CaptureNow +
            '&SellerId=' +
            parameters.SellerId +
            '&SignatureMethod=' +
