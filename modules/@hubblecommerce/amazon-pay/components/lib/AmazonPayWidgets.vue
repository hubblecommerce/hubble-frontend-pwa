        ...
        methods: {
            ...
            getCountryCodeByOrderReference: function() {
                ...
                this.getOrderReferenceDetails(args).then((data) => {
                    this.countryCode = data.GetOrderReferenceDetailsResponse.GetOrderReferenceDetailsResult.OrderReferenceDetails.Destination.PhysicalDestination.CountryCode._text;
            ...
            precalculateShippingCost: function() {
                ...
                this.$store.dispatch('modCart/precalculateShippingCost', {
