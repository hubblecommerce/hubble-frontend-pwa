<template>
    <div>
        <div class="options-wrp">
            <div class="option-wrp" :class="facet" v-for="(facet, index) in facetsAvail" :key="index" :updating="isUpdating">
                <div class="option-label option-label-top" v-text="facet['facet-name']"></div>
                <div  v-if="!hasALotOfOptions(facet)" class="option-val-wrp">
                    <div v-for="(facetValue, vIndex) in facet['facet-values']"
                        ...
                        :class="[facetValue.selected ? 'active' : '', 'not-active']" v-text="getFacetOptionLabel(facet, facetValue)"
                        @click="selectFacetOption(facet, facetValue)"></div>
                </div>
                <div v-if="hasALotOfOptions(facet)" class="select-wrp">
                    <select v-model="selectedOption" @change="changeOption(facet)">
                        <option value="" disabled v-text="$t('Please select')"></option>
                        <option v-for="(facetValue, vIndex) in facet['facet-values']"
                            :key="vIndex"
                            class="option-val is-link"
                            :value="facetValue"
                            v-text="getFacetOptionLabel(facet, facetValue)"></option>
                    </select>
                </div>
            </div>
        </div>
