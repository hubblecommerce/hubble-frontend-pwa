...
<style scoped lang="scss">
    ...
    .expand-leftRight-enter-active, .expand-leftRight-leave-active {
        transition: all .2s ease-in-out;
    }
    .expand-leftRight-enter, .expand-leftRight-leave-to {
        left: -100% !important;
    }
    .expand-leftRight-enter-to, .expand-leftRight-leave {
        left: 0 !important;
    }
