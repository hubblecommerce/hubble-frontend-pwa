<template>
    <div class="autocomplete-list-wrp">
        ...
        <div v-if="showProducts">
            ...
            <div v-for="(product, key) in productItems"
                 :key="key"
                 class="autocomplete-element-wrp"
                 :class="{'selected-item': product.id === selectedItemId}"
            >
                <nuxt-link :to="'/' + product.url_pds"
                           class="autocomplete-element"
                           v-text="product.manufacturer_name + ' ' + product.name"
                />
            </div>
        </div>
