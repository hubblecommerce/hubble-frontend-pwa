...
export default {
    ...
    computed: {
        ...
        classesPriceBox() {
            return [this.itemIsSpecial ? 'special-price' : '', this.itemIsMinimal ? 'minimal-price' : ''];
        },
        itemIsMinimal() {
            return false;
        },
        ...
        itemHasBasePriceAmount() {
            if (!this.item.final_price_item.base_price_amount) {
                return false;
            }
            if (!this.item.final_price_item.base_price_base_amount) {
                return false;
            }
            if (!this.item.final_price_item.base_price_amount.length) {
                return false;
            }
            if (!this.item.final_price_item.base_price_base_amount.length) {
                return false;
            }
