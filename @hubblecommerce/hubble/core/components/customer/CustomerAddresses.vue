<template>
    <div v-if="!isLoading" class="customer-addresses-wrp">
        <div v-if="differentShippingAddress" class="d-flex justify-content-between">
            ...
            <hbl-button class="button" @click.native="createAddress('billing')" v-text="'Create new address'" />
        </div>
        ...
        <div v-else class="d-flex justify-content-between">
            ...
            <hbl-button
                class="button"
                @click.native="createAddress('shipping')"
        ...
        <div class="billing-address-wrp">
            ...
            <hbl-button
                ...
                @click.native="updateAddress(activeBillingAddress, 'billing')"
                v-text="'Edit'"
            />
        </div>
        ...
        <template v-if="differentShippingAddress">
            ...
            <div class="shipping-address-wrp">
                ...
                <hbl-button
                    class="button edit-address"
                    @click.native="updateAddress(activeShippingAddress, 'shipping')"
                    v-text="'Edit'"
                />
            </div>
        </template>
