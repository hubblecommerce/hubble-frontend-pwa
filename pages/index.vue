            ...
            <div class="index-text-wrp">
                <div class="intro-text" style="max-width: 740px; margin: 0 auto; display: block;">
                    ...
                    <div class="text mb-4 text-center">
                        hubble is a frontend-layer boosting legacy eCommerce plattforms. We embrace grown software, preserve existing business
                        processes and deliver a Progressive Web App (PWA) in less than 90 days. Expcect a super high performance, dedicated focus on
                        mobile commerce and extremly fast development cycles. Invest in the technology of tomorrow and scale that effect!
                    </div>
                    ...
                    <div class="text mb-4 text-center">
                        ...
                        Automatically gain full advantages on desktop viewports as well. Address your target groups optimally across devices to expand
                        them in the future.</div>
                    <h2 class="text-center">Any Shop Platform</h2>
                    <div class="text text-center">
                        A quick integration into your existing IT infrastructure while keeping existing business processes make hubble a real game
                        changer. Benefit from the advantages of great user experience and additional individual features. No extra cost for expensive
                        app development.</div>
                    <div class="text text-center">
            ...
            <div v-view.once="onceHandler">
                <div class="new-products-wrp">
                    ...
                    <div class="product-carousel">
                        <product-listing
                            v-if="newProducts.length > 0 && inView"
