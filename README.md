...
**6**: Install dependencies and launch app in dev mode 
``` bash
npm install
npm run dev
```

**7**: Tracking the original repository as a remote fork <br>
...
**9**: Push changes to the code to the fork repository (specify issue ID)
``` bash
git add .
